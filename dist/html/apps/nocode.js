...
export default {  
	...
	'<a-entity>\
	<a-mixin id="torus1" radius-tubular="0.1"></a-mixin> \
	<a-mixin id="torus2" segments-tubular="60"></a-mixin> \
	...
	<a-icosahedron scale=".1 .1 .1" position="0 0.1 0" color="rgba(234,194,99,1)" \
		...
		<a-torus arc="360" radius="1.1" mixin="torus1 torus2" position="0 0 0"  color="rgba(194,23,116,1)" \
			:animation="`property:rotation; easing:linear; to: 0 360 0 ; loop: true; dur: ${speed*1.1};`" shadow> \
			<a-torus arc="360" radius="1.5" mixin="torus1 torus2" position="0 0 0"  color="rgba(146,194,23,1)" \
				:animation="`property:rotation; easing:linear; to: 360 0 0; loop: true; dur: ${speed*1.2};`" shadow> \
				<a-torus arc="360" radius="1.9" mixin="torus1 torus2"  position="0 0 0"  color="#2dbadd" \
